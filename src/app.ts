...
const PRODUCT_DESCRIPTIONS: Record<string, string> = {
  ...
  "Vat 69 200 ml": "Botella de vidrio verde oscuro, formato plano tipo petaca rectangular. Punto visual clave: altura aproximada 50% de una botella de whisky estándar de 1 L. Etiqueta principal negra con dos franjas amarillas horizontales: una delgada en el borde superior y otra más gruesa en el borde inferior. Tapa negra con fina franja amarilla en el borde superior. NO CONFUNDIR con Vat 69 1L (botella cilíndrica alta)",
  "Smirnoff Ice": "Botella de vidrio transparente tipo cerveza (cuello largo y cuerpo corto) que contiene líquido blanco turbio. Punto visual clave: altura aproximada 60% de una botella estándar de 1 L. Etiqueta principal blanca con un bloque rojo visible. Etiqueta blanca en el cuello. Tapa fina de color rojo. Elemento visual clave: líquido blanco turbio.",
