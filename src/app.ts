...
const PRODUCT_DESCRIPTIONS: Record<string, string> = {
  ...
  "Vat 69 1L": "Botella de vidrio verde oscuro con cuerpo cilíndrico tradicional de whisky. Altura equivalente a otras botellas estándar de 1L (como JW Red 1L o JW Black 1L). Etiqueta principal negra de gran tamaño con: dos franjas rojas horizontales finas (una superior y una inferior) texto “VAT 69” en blanco grande en el centro sello circular rojo encima del nombre. Tapa y cápsula del cuello negras con fina franja roja en el borde superior. CRÍTICO: botella alta y cilíndrica. NO CONFUNDIR con Vat 69 200 ml, que es una botella baja tipo petaca rectangular (aprox. 50% de la altura).",
  "Vat 69 200 ml": "Botella de vidrio verde oscuro con formato plano tipo petaca rectangular. Punto visual clave: altura aproximada 50% de una botella estándar de 1L. Etiqueta principal negra con: dos franjas amarillas horizontales una delgada en la parte superior una más gruesa en la parte inferior. Tapa negra con fina franja amarilla en el borde superior. CRÍTICO: botella baja y rectangular tipo petaca. NO CONFUNDIR con Vat 69 1L, que es cilíndrica, mucho más alta y con franjas rojas (no amarillas).",
  ...
  "Vodka Smirnoff 750mL": "Botella de vidrio transparente alta y recta con cuerpo cilíndrico largo. Altura similar a botellas grandes de whisky, cercana a referencias de 1L. Contiene líquido transparente. Etiqueta principal blanca con elementos rojos en el centro. Cuello largo con etiqueta adicional. Tapa metálica roja. CRÍTICO: botella alta, recta y con líquido transparente. NO CONFUNDIR con Smirnoff Ice, que es más baja, tipo botella de cerveza y contiene líquido blanco turbio.",
  "Sandy Mac 1L": "Botella de vidrio muy oscuro (marrón casi negro) con cuerpo rectangular ancho y hombros suaves. Altura ligeramente menor que botellas estándar de whisky de 1 L (como “JW Red 1L” o “Vat 69 1L”). En el cuello presenta una etiqueta angosta de color amarillo claro ubicada entre el cuello y el cuerpo de la botella. Punto visual clave: en la parte inferior del cuerpo aparece una franja horizontal ancha de color beige o amarillo claro, que contrasta fuertemente con la botella oscura y suele ser el elemento más visible incluso en imágenes con poca iluminación. La etiqueta central tiene forma ovalada clara con borde oscuro. Tapa color beige o crema con una fina franja roja en el borde superior. CRÍTICO: botella oscura rectangular con franja horizontal beige/amarilla ancha en la parte inferior. NO CONFUNDIR con White Horse 1L, que tiene botella cilíndrica transparente con una etiqueta amarilla grande que cubre gran parte del frente de la botella, mientras que Sandy Mac tiene botella oscura rectangular y el bloque amarillo aparece en la parte inferior.",
  "JW Blonde": "Botella de vidrio transparente con líquido ámbar interior. Formato 750ml, altura levemente inferior a botellas de 1L ('JW Red 1L' o 'Vat 69 1L'). Misma silueta rectangular que JW Red 1L'  o JW Black 1L'  .\n\nElemento más distintivo Clave: FRANJA DIAGONAL ESTRECHA de color AMARILLO VIBRANTE que cruza el cuerpo de la botella en ángulo ascendente.\nTapa y cápsula del cuello de color AZUL INTENSO."
};
