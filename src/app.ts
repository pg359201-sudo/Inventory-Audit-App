...
const PRODUCT_DESCRIPTIONS: Record<string, string> = {
  ...
  "Vat 69 200 ml": "Botella de vidrio verde oscuro, formato plano tipo petaca rectangular. Punto clave: altura aproximada 50% de una botella de whisky estándar de 1 L (como “JW Red 1L” o “Vat 69 1L”). Etiqueta principal negra con dos franjas amarillas horizontales: una delgada en el borde superior y otra más gruesa en el borde inferior. Tapa negra con fina franja amarilla en el borde superior.",
  "Smirnoff Ice": "Botella de vidrio transparente tipo cerveza (cuello largo y cuerpo corto) que contiene líquido blanco turbio. Altura aproximada 60% de una botella estándar de 1 L (como “JW Red 1L” o “Vat 69 1L”). Etiqueta principal blanca en el cuerpo con un bloque rojo visible. Etiqueta blanca en el cuello. Tapa fina de color rojo",
  ...
  "White Horse 200 ml": "Botella de vidrio transparente con formato plano tipo petaca rectangular, que contiene líquido color ámbar. Altura aproximada 50% de una botella estándar de 1 L (como “JW Red 1L” o “Vat 69 1L”). Etiqueta principal amarilla con texto rojo grande en diagonal.Tapa y cápsula del cuello de color amarillo."
};
