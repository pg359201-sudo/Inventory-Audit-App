...
const PRODUCT_DESCRIPTIONS: Record<string, string> = {
  ...
  "Vat 69 200 ml": "Botella de vidrio color verde oscuro con formato plano (tipo petaca rectangular). Altura aproximada a la mitad de las botellas “JW Red 1L” o “Vat 69 1L”. Etiqueta principal con fondo negro, delimitada por dos franjas horizontales amarillas una en el borde superior y otra mas gruesa en el inferior. Tapa superior negra con una fina franja amarilla en el borde superior.",
