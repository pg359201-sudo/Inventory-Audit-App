...
const PRODUCT_DESCRIPTIONS: Record<string, string> = {
  ...
  "Sandy Mac 1L": "Botella de vidrio muy oscuro (marrón casi negro) con cuerpo rectangular ancho y hombros suaves.\nAltura ligeramente menor que botellas estándar de whisky de 1 L (como “JW Red 1L” o “Vat 69 1L”).\nEn el cuello presenta una etiqueta angosta de color amarillo claro ubicada entre el cuello y el cuerpo de la botella.\nPunto visual clave: en la parte inferior del cuerpo aparece una franja horizontal ancha de color beige o amarillo claro, que contrasta fuertemente con la botella oscura y suele ser el elemento más visible incluso en imágenes con poca iluminación.\nLa etiqueta central tiene forma ovalada clara con borde oscuro.\nTapa color beige o crema con una fina franja roja en el borde superior.\nCRÍTICO: botella oscura rectangular con franja horizontal beige/amarilla ancha en la parte inferior.\nNO CONFUNDIR con White Horse 1L, que tiene botella cilíndrica transparente con una etiqueta amarilla grande que cubre gran parte del frente de la botella, mientras que Sandy Mac tiene botella oscura rectangular y el bloque amarillo aparece en la parte inferior.",
