...
const PRODUCT_DESCRIPTIONS: Record<string, string> = {
  ...
  "Gin Royale": "Botella violeta oscuro con silueta tipo coctelera (hombros redondeados pronunciados). Tapa superior de color violeta. En la parte superior del cuerpo destaca un distintivo sello redondo rojo tipo lacre. La etiqueta principal es un bloque central blanco con bordes oscuros (verdes/amarillos), y justo debajo tiene una franja horizontal gruesa y muy visible de color verde claro. Altura levemente inferior a botellas “JW Red 1L” o “Vat 69 1L”).",
  ...
  "Sandy Mac 1L": "Botella de vidrio marrón oscuro con cuerpo rectangular ancho. Altura aproximada 75% de una botella estándar de whisky de 1 L (como “Vat 69 1L” o “JW Red 1L”). Presenta una etiqueta angosta amarilla entre el cuello y el cuerpo. Punto visual clave: en la parte inferior del cuerpo aparece una franja horizontal ancha de color amarillo/beige, que contrasta con la botella oscura. Tapa color beige o crema con una fina franja roja en el borde superior",
