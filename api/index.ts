...
const PRODUCT_DESCRIPTIONS: Record<string, string> = {
  ...
  "Gin Tanqueray": "Botella de vidrio color verde oscuro con silueta inspirada en una coctelera (hombros redondeados pronunciados y cuerpo cilíndrico). Altura levemente inferior a referencias estándar de 1L (JW Black, JW Red, Vat 69). Presenta un distintivo sello redondo en relieve tipo lacre color rojo en el hombro frontal, debajo del cuello. Etiqueta principal dividida: bloque superior de fondo blanco destacando la palabra 'Tanqueray' en cursiva, y bloque inferior de color plateado, separados por una línea horizontal oscura. Tapa superior a rosca de color plateado liso.",
  "Gin Sevilla": "Botella de vidrio transparente con silueta inspirada en una coctelera (hombros redondeados pronunciados), que contiene líquido color ámbar/naranja claro. Altura levemente inferior a referencias estándar de 1L (JW Black, JW Red, Vat 69). Presenta un distintivo sello redondo en relieve tipo lacre color rojo en el hombro frontal. Etiqueta principal con fondo predominantemente blanco, con ilustraciones botánicas (tonos verde y naranja) en los bordes. Destaca la palabra 'Tanqueray' en cursiva negra y la palabra 'SEVILLA' en letras mayúsculas grandes. El bloque inferior de la etiqueta es una franja horizontal gruesa de color rojo/naranja. Tapa superior a rosca de color rojo liso.",
  "Gin Royale": "Botella de vidrio transparente con silueta inspirada en una coctelera (hombros redondeados pronunciados), que contiene líquido color violeta oscuro/púrpura. Altura levemente inferior a referencias estándar de 1L (JW Black, JW Red, Vat 69). Presenta un distintivo sello redondo en relieve tipo lacre color rojo en el hombro frontal. Etiqueta principal con fondo central blanco, rodeada por un marco botánico grueso y texturado en tonos verde oscuro, dorado/amarillo y pequeños puntos violetas. En el centro destaca la palabra 'Tanqueray' en cursiva negra, y 'ROYALE' en letras mayúsculas negras grandes. Debajo de esta etiqueta principal, presenta una franja horizontal gruesa de color verde claro. Tapa superior a rosca de color violeta liso.",
  "White Horse 1L": "Botella de vidrio transparente con cuerpo cilíndrico, que contiene líquido color ámbar. Altura equivalente a referencias de 1L (JW Black, JW Red, Vat 69). Etiqueta principal muy amplia con fondo amarillo. Destacan las palabras 'White Horse' en letras rojas grandes dispuestas en ángulo ascendente (diagonal). En la parte superior central de la etiqueta presenta un pequeño recuadro negro que contiene la silueta de un caballo blanco. En su límite inferior, la etiqueta tiene una franja horizontal oscura (marrón/negra). Tapa y cápsula del cuello predominantemente negras con finas líneas doradas/amarillas.",
  "White Horse 200 ml": "Botella de vidrio transparente con formato plano (tipo petaca rectangular), que contiene líquido color ámbar. Altura aproximada a la mitad de la referencia de 1L. Etiqueta principal con fondo amarillo. Destacan las palabras 'White Horse' en letras rojas grandes dispuestas en ángulo ascendente (diagonal). En la parte superior central de la etiqueta presenta un pequeño recuadro negro que contiene la silueta de un caballo blanco. Tapa y cápsula del cuello de color amarillo liso.",
  ...
  "Smirnoff Ice": "Botella de vidrio transparente pequeña con cuello largo y hombros en declive (formato tipo cerveza), que contiene líquido color blanco turbio/nublado. Altura aproximada al 60% de referencias estándar (JW Red 1L). Etiqueta principal en el cuerpo de fondo blanco; en su centro presenta la palabra 'SMIRNOFF' en blanco sobre un fondo rojo, la palabra 'ICE' en letras negras, y un bloque rojo sólido en forma de escudo en su base. El cuello está recubierto por una segunda etiqueta blanca con un pequeño logo rojo. Tapa fina tipo corona (chapa) de color rojo.",
  "Sandy Mac 1L": "Botella de color marrón oscuro. Tiene un cuerpo rectangular, con bordes y hombros redondeados, y presenta una textura rugosa tipo craquelado en el vidrio. La altura exclusiva de este cuerpo equivale aproximadamente al 50% de la altura total de un 'Vat 69 1L' o de la línea 'JW 1L'.Tiene una etiqueta amarilla en forma de banda curva ubicada horizontalmente sobre los hombros de la botella, justo donde termina el cuerpo texturizado. Tapa de color beige (o crema) con una fina banda roja en el borde superior"
};
