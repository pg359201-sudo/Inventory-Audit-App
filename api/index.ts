...
const PRODUCT_DESCRIPTIONS: Record<string, string> = {
  ...
  "Gin Royale": "Diferencial clave: Tapa color violeta. Buscar bloque de color violeta oscuro o uva. Etiqueta blanca con un marco con tono de colores violetas, verdes y amarillos, también existe la palabra 'Royale'. Entre la etiqueta y la tapa superior, hay un punto/sello rojo.",
